<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?php if($pageName=='Dashboard'){ echo 'active bg-gradient-'.$sidebar_color;}?>" href="dashboard.php?pageName=Dashboard">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php if($pageName=='Tables'){ echo 'active bg-gradient-'.$sidebar_color;}?> " href="tables.php?pageName=Tables">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-<?php echo $sidebar_color; ?> mt-4 w-100" href="logout.php" type="button">Logout</a>
      </div>
    </div>
  </aside>